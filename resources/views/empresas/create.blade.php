                        ...
                        <form method="post" action="{{ route('empresas.store') }}" enctype="multipart/form-data">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Dados da Empresa') }}</h6>
                                ...
                                <div class="form-group{{ $errors->has('logomarca') ? ' has-danger' : '' }}">
                                    ...
                                    @if ($errors->has('logomarca'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('logomarca') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('cnpj') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="cnpj" id="cnpj" class="form-control form-control-alternative{{ $errors->has('cnpj') ? ' is-invalid' : '' }}"  value="{{ old('cnpj') }}">
                                ...
                                <div class="form-group{{ $errors->has('razao_social') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="razao_social" id="input-razao_social" class="form-control form-control-alternative{{ $errors->has('razao_social') ? ' is-invalid' : '' }}" value="{{ old('razao_social') }}" >
                                ...
                                <div class="form-group{{ $errors->has('nome_fantasia') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome_fantasia" id="input-nome_fantasia" class="form-control form-control-alternative{{ $errors->has('nome_fantasia') ? ' is-invalid' : '' }}" value="{{ old('nome_fantasia') }}">
