                        ...
                        <form method="post" action="{{ route('empresas.update',$empresa->id) }}" enctype="multipart/form-data">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Dados da Empresa') }}</h6>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ url("storage/{$empresa->logomarca}")}}" onClick="triggerClick()" alt="" id="profileDisplay">
                                ...
                                <div class="form-group{{ $errors->has('cnpj') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="cnpj" id="cnpj" class="form-control form-control-alternative{{ $errors->has('cnpj') ? ' is-invalid' : '' }}"  value="{{ $empresa->cnpj }}">
                                ...
                                <div class="form-group{{ $errors->has('razao_social') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="razao_social" id="input-razao_social" class="form-control form-control-alternative{{ $errors->has('razao_social') ? ' is-invalid' : '' }}" value="{{ $empresa->razao_social }}" >
                                ...
                                <div class="form-group{{ $errors->has('nome_fantasia') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome_fantasia" id="input-nome_fantasia" class="form-control form-control-alternative{{ $errors->has('nome_fantasia') ? ' is-invalid' : '' }}" value="{{ $empresa->nome_fantasia }}">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ $empresa->email }}" >
