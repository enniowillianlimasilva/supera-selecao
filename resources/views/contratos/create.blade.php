                        ...
                        <form method="post" action="{{ route('contratos.store') }}" enctype="multipart/form-data">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Dados do Contrato') }}</h6>
                                ...
                                <div class="form-group{{ $errors->has('descricao') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="descricao" id="input-descricao" class="form-control form-control-alternative{{ $errors->has('descricao') ? ' is-invalid' : '' }}" value="{{ old('descricao') }}">
                                ...
                                <div class="form-group{{ $errors->has('data_inicio') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="data_inicio" id="input-data_inicio" class="form-control form-control-alternative{{ $errors->has('data_inicio') ? ' is-invalid' : '' }}" value="{{ old('data_inicio') }}">
                                ...
                                <div class="form-group{{ $errors->has('data_fim') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="data_fim" id="input-data_fim" class="form-control form-control-alternative{{ $errors->has('data_fim') ? ' is-invalid' : '' }}" value="{{ old('data_fim') }}">
